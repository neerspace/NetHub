...
const ArticleCreateTinyInput: ForwardRefRenderFunction<ITinyInputHandle, ITinyInputProps> =
  ({data, setData, editorTitle, isInvalid, errorMessage}, ref) => {
    ...
    return (
      <div className={cl.tinyInput}>
        <p>{editorTitle}</p>
        <FormControl width={'100%'} isInvalid={isInvalid}>
          <div className={isInvalid ? cl.wrong : ''}>
            <Editor
...
export default forwardRef(ArticleCreateTinyInput);
