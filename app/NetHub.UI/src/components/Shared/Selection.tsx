...
import cl from "./Shared.module.sass"
...
const Selection: FC<IThemeTagProps> = ({value, onClick, active, onHover, children, isDisabled}) => {
  ...
  return <Text
    ...
    as={'p'} onClick={() => onClick ? onClick(value) : {}} className={cl.selection}
    bg={tagBg} display={'block'} height={'fit-content'}
  >
    {children ?? value}
  </Text>
};
